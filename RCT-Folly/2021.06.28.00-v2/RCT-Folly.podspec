...
Pod::Spec.new do |spec|
  ...
  spec.source_files = 'folly/String.cpp',
                      ...
                      'folly/net/detail/*.h',
                      'folly/portability/*.h'
  spec.public_header_files = 'folly/**/*.h', 'folly/*.h'
  ...
  spec.pod_target_xcconfig = { "USE_HEADERMAP" => "NO",
                               ...
                               "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/RCT-Folly/\" \"$(PODS_ROOT)/RCT-Folly/\" \"$(PODS_ROOT)/boost-for-react-native\" \"$(PODS_ROOT)/DoubleConversion\" \"$(PODS_ROOT)/libevent/include/\" \"$(PODS_ROOT)/fmt/\" \"$(PODS_ROOT)/fmt/include/\"" }
