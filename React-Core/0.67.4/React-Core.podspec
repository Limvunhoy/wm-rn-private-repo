...
Pod::Spec.new do |s|
  ...
  header_subspecs.each do |name, headers|
    s.subspec name do |ss|
      ...
      # Ignore duplication, will add more condition since file is in here
      # Compare only this dir, we apply the exclude files
      ss.exclude_files = "React/CoreModules/RCTAlertController.h"
